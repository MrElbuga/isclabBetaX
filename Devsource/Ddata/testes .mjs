        ...
        uma instância de um relacionamento entre entidades.`),d:new aln(`Uma entidade forte existe na base de dados e possui atributos que a identificam sem que ela
         ...
         let teste6 = [
            ...
            uma comissão ordenados por titulo. `),b:new aln(`Listar todos os dados dos empregados que não tem comissão ordenados por 2 `),c:new aln(`Listas todos os dados de tabela Empregado ordenados por 2.`),d:new aln(`Todas as afirmações acima.`),e:new aln(`Nenhuma das alternativas. `,0),imgs:[require(`../testespics/teste21.50.jpg`)]})
             ...
             let testex =[
new Prg({cadNome:`Bd1`,pId:`/0`,testRef:``,tema:`kalika`,
 prg:`oque e makima?`,a:new aln(`Demon`),b:new aln(`denji`),c:new aln(`makima`,0),d:new aln(`Woman`,0),e:new aln(`demon woman`,0),imgs:[] }),
new Prg({cadNome:`Bd1`,pId:`/1`,testRef:``,tema:``,
 prg:`emp de  iphone?`,a:new aln(`apple`,0),b:new aln(`denji`),c:new aln(`makima`),d:new aln(`cidade`),e:new aln(`game`),imgs:[`require('den  ') `] }),
new Prg({cadNome:`Bd1`,pId:`/2`,testRef:``,tema:`kalika`,
 prg:`Em  Que ramo se localiza o
,,,, Adidas?`,a:new aln(`Comida`),b:new aln(`Musica`),c:new aln(`Desporto`,0),d:new aln(`tecnologia`),e:new aln(``),imgs:[] }),
new Prg({cadNome:`Bd1`,pId:`/3`,testRef:``,tema:`asax`,
 prg:`onde se localiza isctem?`,a:new aln(`africa do sul`),b:new aln(`Maputo
,,,  ,ou
,,,,cidade de maputo`,0),c:new aln(`Nigeria`),d:new aln(`nenhum plac`),e:new aln(``),imgs:[`require('katlyn  ') ,{uri:'kolin   '} ,{uri:'marlyn   '} `] })
 ];
